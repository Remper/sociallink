...
public class DistanceTaxicab extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 378939673;

    /**
     * The parameter <code>public.distance_taxicab.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.distance_taxicab._1</code>.
     */
    ...
    /**
     * The parameter <code>public.distance_taxicab._2</code>.
     */
     ...
     */
    public DistanceTaxicab() {
        super("distance_taxicab", Public.PUBLIC, org.jooq.impl.SQLDataType.DOUBLE);
