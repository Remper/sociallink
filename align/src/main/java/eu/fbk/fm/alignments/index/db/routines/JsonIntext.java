...
public class JsonIntext extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1597948033;

    /**
     * The parameter <code>public.json_intext.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.json_intext._1</code>.
     */
     ...
     */
    public JsonIntext() {
        super("json_intext", Public.PUBLIC, org.jooq.impl.SQLDataType.OTHER);
