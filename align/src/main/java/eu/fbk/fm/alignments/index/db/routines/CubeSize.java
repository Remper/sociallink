...
public class CubeSize extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -1204143557;

    /**
     * The parameter <code>public.cube_size.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.cube_size._1</code>.
     */
     ...
     */
    public CubeSize() {
        super("cube_size", Public.PUBLIC, org.jooq.impl.SQLDataType.DOUBLE);
