...
public class CubeEnlarge extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -547238596;

    /**
     * The parameter <code>public.cube_enlarge.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.cube_enlarge._1</code>.
     */
     ...
     */
    public CubeEnlarge() {
        super("cube_enlarge", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"));
