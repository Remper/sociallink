...
public class CubeToArray extends AbstractRoutine<Double[]> {

    private static final long serialVersionUID = -2145980185;

    /**
     * The parameter <code>public.cube_to_array.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.cube_to_array._1</code>.
     */
     ...
     */
    public CubeToArray() {
        super("cube_to_array", Public.PUBLIC, org.jooq.impl.SQLDataType.FLOAT.getArrayDataType());
