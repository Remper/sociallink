...
public class GCubeDecompress extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1864166305;

    /**
     * The parameter <code>public.g_cube_decompress.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.g_cube_decompress._1</code>.
     */
     ...
     */
    public GCubeDecompress() {
        super("g_cube_decompress", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
