...
public class CubeCoordLlur extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 865359780;

    /**
     * The parameter <code>public.cube_coord_llur.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.cube_coord_llur._1</code>.
     */
    ...
    /**
     * The parameter <code>public.cube_coord_llur._2</code>.
     */
     ...
     */
    public CubeCoordLlur() {
        super("cube_coord_llur", Public.PUBLIC, org.jooq.impl.SQLDataType.DOUBLE);
