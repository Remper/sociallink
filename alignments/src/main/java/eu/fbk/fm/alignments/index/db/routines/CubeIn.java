...
public class CubeIn extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1670062426;

    /**
     * The parameter <code>public.cube_in.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.cube_in._1</code>.
     */
     ...
     */
    public CubeIn() {
        super("cube_in", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"));
