...
public class DBpediaSpec implements ResourceSpec {
    ...
    public static final String WD_DEATHDATE_PROP = "P570";
    public static final String WD_DEATHPLACE_PROP = "P20";
    public static final String WD_DEATHCAUSE_PROP = "P509";
    ...
    public static final String[] DEAD_PERSON_ATTRIBUTES = {
            ATTRIBUTE_DEATHDATE, ATTRIBUTE_DEATHPLACE, ATTRIBUTE_DEATHCAUSE, ATTRIBUTE_DEATHCAUSE_REVERSED, ATTRIBUTE_DEATHYEAR,
            WIKIDATA_ENTITY+WD_DEATHDATE_PROP, WIKIDATA_DIRECT_PROP+WD_DEATHDATE_PROP,
            WIKIDATA_ENTITY+WD_DEATHPLACE_PROP, WIKIDATA_DIRECT_PROP+WD_DEATHPLACE_PROP,
            WIKIDATA_ENTITY+WD_DEATHCAUSE_PROP, WIKIDATA_DIRECT_PROP+WD_DEATHCAUSE_PROP
    };
