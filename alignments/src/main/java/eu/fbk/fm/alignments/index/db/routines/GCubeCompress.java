...
public class GCubeCompress extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1677734690;

    /**
     * The parameter <code>public.g_cube_compress.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.g_cube_compress._1</code>.
     */
     ...
     */
    public GCubeCompress() {
        super("g_cube_compress", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
